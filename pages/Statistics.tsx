...
import { Trophy, Flame, CheckCircle2, TrendingUp, Share2, RefreshCw } from 'lucide-react';
      ...
      <div className="relative z-10 space-y-8">
        <header className="flex justify-between items-start">
            ...
            <button 
                ...
                className={cn(
                    "w-12 h-12 rounded-full bg-surface/50 dark:bg-slate-800/50 flex items-center justify-center text-secondary shadow-sm active:scale-95 transition-all border border-white/20",
        ...
        <ReferralCard />
        {!isLoading && <AchievementsGrid user={userProfile} totalCompleted={totalCompletions} />}
        {isLoading ? (
        ...
        <div>
            ...
            <div className="bg-gradient-to-br from-[#4F46E5] to-[#7C3AED] dark:from-[#4338ca] dark:to-[#6d28d9] rounded-[2rem] p-6 text-white shadow-xl relative overflow-hidden">
